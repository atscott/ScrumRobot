...
public class JPlotControllerTest {
	...
	/**
	 * This test is testing the allowing a user to change modes, and also testing the actual changing of what mode
	 * you are in because the allow change method simply calls the change mode method if it is allowed.
	 */
	@Test
	...
	@Test(dependsOnMethods = {"setGridDensityTest"})
